...
var Docs = {
	...
	shebang: function() {
		...
		var fragments = decodeURI($.param.fragment()).split('/');
...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  var serviceName = webroot+depth0.path;
  serviceName = serviceName.split("/").join('.').substr(1);
  buffer += "\n        <h4 style='color:red;'>服务名称</h4>\n        <p>"+serviceName+"</p>";
  buffer += "\n        <h4>接口说明</h4>\n        <p>";
...
function program20(depth0,data) {
  ...
  return "\n          <div class='sandbox_header'>\n            <input class='submit' name='commit' type='button' value='确定' />\n            <a href='#' class='response_hider' style='display:none'>隐藏响应</a>\n            <img alt='Throbber' class='response_throbber' src='images/throbber.gif' style='display:none' />\n          </div>\n          ";
  }
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "</a> <font color=#89bf04 style='font-size:14px;'>";
  options = {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data};
