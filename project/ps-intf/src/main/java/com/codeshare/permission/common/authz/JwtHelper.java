package com.codeshare.permission.common.authz;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.codeshare.common.JsonUtils;
import com.codeshare.permission.common.Constants;
import com.codeshare.permission.user.dto.DesignerVo;
import com.codeshare.permission.user.dto.IUser;
import com.codeshare.permission.user.dto.UserQueryRes;
...
public class JwtHelper {
    ...
    public static IUser getCurrentUser() {
        IUser user = null;
        String subject = Optional.ofNullable(currentClaims.get()).map(Claims::getSubject).get();
        if (subject != null) {
